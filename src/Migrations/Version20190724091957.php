 ...
 */
final class Version20190724091957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, bike_id INT NOT NULL, customer_id INT NOT NULL, track_date DATE NOT NULL, create_at DATETIME NOT NULL, status SMALLINT NOT NULL, INDEX IDX_42C84955D5A4816F (bike_id), INDEX IDX_42C849559395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
